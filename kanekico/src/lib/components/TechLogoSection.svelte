<div class="grid gap-10 md:grid-cols-3 lg:grid-cols-5 place-items-center md:gap-20 my-20 2xl:mx-32">
	<img class="w-20 h-20" src="/img/logos/react.svg" alt="react logo" />
	<img class="w-20 h-20" src="/img/logos/svelte.svg" alt="svelte logo" />
	<img class="w-20 h-20" src="/img/logos/html.svg" alt="html logo" />
	<img class="w-20 h-20" src="/img/logos/pocketbase.svg" alt="pocketbase logo" />
	<img class="w-20 h-20" src="/img/logos/astro.svg" alt="astro logo" />
	<img class="w-36" src="/img/logos/django.svg" alt="django logo" />
	<img class="w-28 h-28" src="/img/logos/next.svg" alt="nextjs logo" />
	<img class="w-44" src="/img/logos/tailwind.svg" alt="tailwind logo" />
	<img class="w-28 h-28" src="/img/logos/strapi.svg" alt="strapi logo" />
	...
	<svg
		...
		viewBox="0 0 105 36"
		class="md:col-span-3 lg:col-auto"
		><title id="saleorlogo">saleor logo</title><mask
			id="prefix__logo"
			width="105"
			height="35"
			x="0"
